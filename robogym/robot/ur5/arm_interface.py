...
# the UR arm
TABLETOP_EXPERIMENT_INITIAL_POS = np.array([1.47136875, -1.18532706, 2.09414952, 0.63852077, 1.57972497, -0.04763958])
# TABLETOP_EXPERIMENT_INITIAL_POS = np.array([1.497, -0.965, 1.712, 0.802, 1.579, -0.022])
