...
from robogym.robot.ur5_factories import build_tcp_controller
from robogym.robot.robot_interface import RobotControlParameters
from robogym.robot.ur5.arm_interface import TABLETOP_EXPERIMENT_INITIAL_POS, Arm
from robogym.robot.ur5.mujoco.free_dof_tcp_arm import FreeDOFTcpArm
from robogym.robot.ur5.mujoco.joint_controlled_arm import MujocoObservation
...
class IdealJointControlledTcpArm(Arm):
    ...
    def __init__(
        ...
        self.simulation.register_joint_group(
            self.joint_group, prefix=robot_prefix
        )
