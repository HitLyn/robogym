...
from robogym.robot.ur5.arm_interface import Arm
...
class FreeDOFTcpArm(Arm):
    """
     Mujoco implementation of a tool center point (TCP) actuated UR 5 arm
    ...
    def get_name(self) -> str:
        return "unnamed-mujoco-ur5-tcp-arm"
    ...
    def get_robot_transform(self) -> Optional[np.ndarray]:
        ...
        robot_xyz = self.mj_sim.data.get_body_xpos(
            f"{self.robot_prefix}_base_link"
        ).copy()
