...
from robogym.robot.ur5_composite.composite_robot import CompositeRobot
...
from robogym.robot.ur5.mujoco.joint_controlled_arm import JointControlledArm
from robogym.robot.ur5.mujoco.joint_controlled_tcp_arm import JointControlledTcpArm
...
def build_composite_robot(
    ...
    if robot_control_params.requires_solver_sim():
        ...
        robot_cls = IdealJointControlledTcpArm  # MocapActuated, TCPControlled
