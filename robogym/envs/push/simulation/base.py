...
from robogym.envs.push.common.utils import (
    PlacementArea,
    geom_ids_of_body,
    get_all_vertices,
...
from robogym.robot.ur5_composite.ur_gripper_arm import build_composite_robot
from robogym.robot.robot_interface import RobotControlParameters
from robogym.robot.ur5.mujoco.simulation.base import ArmSimulationInterface
...
class RearrangeSimulationInterface(
    ...
    """
    Creates a SimulationInterface with a push-compatible robot-gripper and a
    table setup. Subclass this and implement make_objects_xml() to create other tasks.
    """

    # For push task, we recreate simulation during environment reset, in order to avoid
    ...
    def get_gripper_geom_ids(self) -> List[int]:
        ...
        finger_1_geom_id = _get_geom_id("s_model_finger_2_link_0")
        finger_2_geom_id = _get_geom_id("s_model_finger_2_link_0")
        finger_middle_geom_id = _get_geom_id("s_model_finger_middle_link_0")

        return [finger_1_geom_id, finger_2_geom_id, finger_middle_geom_id]
    ...
    def get_wrist_cam_collisions(self):
        ...
        geom_id = self.mj_sim.model.geom_name2id("ur5_vision_cam_wrist")
        ...
        def _map_contact_to_group(geom: Optional[str]):
            ...
            if geom == "table_collision_plane":
                return geom
            elif geom is not None and geom.startswith("ur5"):
                return "robot"
            return "object"
    ...
    def set_object_colors(self, colors=None):
        ...
        for i in range(self.num_objects):
            ...
            self.mj_sim.model.geom_rgba[target_geom_ids, -1] = 0.6
