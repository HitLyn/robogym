...
from robogym.envs.push.datasets.envstates.utils import get_envstate_datasets
from robogym.envs.push.datasets.objects.utils import get_object_datasets
from robogym.envs.push.simulation.base import ObjectGroupConfig
...
class MixtureRearrangeEnvConstants(MeshRearrangeEnvConstants):
    ...
    object_config: Dict[str, Dict[str, Any]] = {
        "ycb": {
            "function": "robogym.envs.push.datasets.objects.local_mesh:create",
    ...
    dataset_config: Dict[str, Dict[str, Any]] = {
        "ycb_dataset": {
            "function": "robogym.envs.push.datasets.envstates.random:create",
